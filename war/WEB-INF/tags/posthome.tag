...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<br>
			<a href="http://cavaleirosdoapocalipse.com.br/post/${namekey}">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<a href="http://cavaleirosdoapocalipse.com.br/post/${namekey}#disqus_thread">COMENT¡ÅRIOS</a>
			</div>
			<div class="col-md-3">
				<a class="btn btn-primary btn-xs" href="http://cavaleirosdoapocalipse.com.br/post/${namekey}">Continue lendo <i class="fa fa-long-arrow-right"></i></a>
			</div>
		</div>
	</div>
</div>
